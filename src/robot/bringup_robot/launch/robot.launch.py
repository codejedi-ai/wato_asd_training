...
def generate_launch_description():
    ...
    # Static transform from sim_world to base_link frame
    # This provides the robot base frame for odometry
    static_transform_sim_world_to_base_link = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        name="static_transform_sim_world_to_base_link",
        arguments=["0", "0", "0", "0", "0", "0", "sim_world", "base_link"],
    )
    ld.add_action(static_transform_sim_world_to_base_link)
